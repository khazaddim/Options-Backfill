# Change: Add EODHD backfill milestone 0 and 1 foundation

## Why
The EODHD options backfill effort needs a formal scope freeze and durable database foundation before async network orchestration begins. Capturing Milestones 0 and 1 as an OpenSpec change improves reviewability, reduces implementation drift, and creates explicit acceptance gates.
...
- Affected docs: docs/eodhd_options_backfill_downloader_design.md
...
## Roadmap Alignment
- Source roadmap: docs/eodhd_options_backfill_downloader_design.md
