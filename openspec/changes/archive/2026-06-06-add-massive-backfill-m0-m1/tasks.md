...
## 3. Validation
- [x] 3.0 Confirm proposal, design, and tasks remain aligned with docs/massive_options_backfill_downloader_design.md Milestones 0-1.
- [x] 3.1 Run openspec validate add-massive-backfill-m0-m1 --strict.
